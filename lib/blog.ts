// lib/blog.ts
// Споделени типове и helper функции за блог системата.
...
// ── Fallback excerpt от първия paragraph блок, ако excerpt не е попълнен ──────
export function deriveExcerpt(post: Pick<BlogPost, 'excerpt' | 'content'>, maxLen = 160): string {
