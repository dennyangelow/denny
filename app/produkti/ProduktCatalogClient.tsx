                    ...
                    <a href={pageUrl} className="pk-card-img-wrap" tabIndex={-1} aria-hidden="true">
                      ...
                      {p.image_url ? (
                        <SafeImg
                          ...
                          // ⚠️ ФИКС v3 (PageSpeed продължава да показва "larger
                          // than needed" — реалната desktop ширина, измерена от
                          // PageSpeed, е 122px, не 190px). Причина: max-height:180px
                          // + object-fit:contain върху портретна снимка (бутилка/
                          // пакет) дава рендната ширина ≈ 180 × (реално aspect
                          // ratio на конкретния продукт, típично 0.6-0.68) ≈ 108-122px
                          // — 190px беше твърде щедра горна граница. Свалено до
                          // 150px (същата стойност вече ползвана безопасно на
                          // (max-width:960px) breakpoint-а) — пази малко запас за
                          // по-широки/квадратни продукти, без да пилее bandwidth
                          // за типичните тесни бутилки/пакети.
