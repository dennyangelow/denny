...
export function Sidebar({ tab, setTab, newOrders, mobileOpen, setMobileOpen }: Props) {
  return (
    <>
      <style>{`
        .sidebar {
          width: 220px; background: #0f1f16; display: flex; flex-direction: column;
          position: fixed; top: 0; bottom: 0; left: 0; z-index: 50;
          transition: transform .3s cubic-bezier(.4,0,.2,1);
        }
        .sidebar-logo {
          padding: 22px 18px 18px; display: flex; align-items: center; gap: 10px;
          border-bottom: 1px solid rgba(255,255,255,.06);
        }
        .sidebar-logo-mark {
          width: 34px; height: 34px; background: #2d6a4f;
        ...
        .nav-item {
          ...
          color: rgba(255,255,255,.45); font-family: 'DM Sans', sans-serif; font-size: 13.5px;
        ...
        .nav-item--active::before {
          ...
          width: 3px; height: 18px; background: #4ade80; border-radius: 0 3px 3px 0;
        }
        .nav-icon { font-size: 14px; width: 18px; text-align: center; flex-shrink: 0; opacity: .7; }
        .nav-item--active .nav-icon { opacity: 1; }
        .nav-badge {
          background: #ef4444; color: #fff; border-radius: 99px;
          font-size: 10px; padding: 2px 6px; font-weight: 700; margin-left: auto;
        ...
        .sidebar-footer a {
          color: rgba(255,255,255,.3); font-size: 12px; text-decoration: none;
        ...
        .mobile-menu-btn {
          ...
          width: 38px; height: 38px; background: #0f1f16; border: none;
